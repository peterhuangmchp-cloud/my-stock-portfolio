...
try:
    ...
    # --- 4. 數據同步 (改為 12 個月) ---
    with st.spinner('正在同步 12 個月行情數據...'):
        ...
        for index, row in df.iterrows():
            ...
            # 抓取 12 個月歷史數據
            h_data = tk.history(period="12mo", auto_adjust=False)['Close']
    ...
    y_min = trend_data['Total_MV'].min() * 0.97
    y_max = trend_data['Total_MV'].max() * 1.03
